						...
						<div class="col-sm-8">
							<div class="shop-menu pull-right">
								...
								?>
									...
									if($customer_id!=NULL){
									?>
									<li><a href="{{URL::to('/history/'.$customer_id)}}"><i class="fa fa-lock"></i> Lịch sử đặt hàng</a></li>
									<?php
									}else {
										?>
									<li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-lock"></i> Lịch sử đặt hàng</a></li>
									<?php
									}
									?>
									...
									<li>
										...
										<img width="10%" src="{{URL::to('public/frontend/images/human.png')}}">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" name="search_keyword_submit" class="btn btn-success btn-sm" value="Tìm kiếm">
							</div>
							</form>
						</div>
					</div>
						...
						<div id="slider-carousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									...
									<div class="col-sm-6">
										<img src="{{('public/frontend/images/hinh-nen-sach-10.jpg')}}" class="girl img-responsive" alt="" />
								...
								<div class="item">
									...
									<div class="col-sm-6">
										<img src="{{('public/frontend/images/275.jpg')}}" class="girl img-responsive" alt="" />
								...
								<div class="item">
									...
									<div class="col-sm-6">
										<img src="{{('public/frontend/images/467.jpg')}}" class="girl img-responsive" alt="" />
										<img src="images/home/pricing.png" class="pricing" alt="" />
									</div>
								</div>
