                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/save-category-product')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize:none" rows="6" type="password" name="category_name_desc"class="form-control" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
