          ...
          @foreach($admin as $key => $user)
            <form action="{{url('/assign-roles')}}" method="POST">
              ...
              <td>
                ...
                <a  class="btn btn-sm btn-danger "href="{{url('/delete-user-roles/'.$user->admin_id)}}">Xoá user</a>
                <a  class="btn btn-primary "href="{{url('/impersonate/'.$user->admin_id)}}">Chuyển quyền</a>
              </td> 
